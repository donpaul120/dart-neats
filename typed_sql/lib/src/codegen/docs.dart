...
String onConflict(String rowInstanceName) =>
    '''
    ...
    * `.update(($rowInstanceName, excluded, set) => set(...))` to
...
/// Documentation for `.update` in `db.insert(...).onConflict(...).update(...)`.
String onConflictUpdate(String rowInstanceName) =>
    '''
    ...
    [updateBuilder]. The [updateBuilder] is given 3 parameters:
      * `$rowInstanceName` an [Expr] representing the existing row in
        the database,
